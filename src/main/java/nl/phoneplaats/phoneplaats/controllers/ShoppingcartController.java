...
public class ShoppingcartController {
	...
	public String addToShoppingCart(Model model, Product product, int quantity, HttpSession session) {
		...
		orderItem.setSellingPrice(prod.getProductPrice());
	  ...
	  public String checkout(Model model
		...
		if(!error.isEmpty()) {
			if(error.equals("PersonalInfoError")) {
				...
				errorMessage = "Er is een fout opgetreden tijdens de betaling, de betaling ging niet door. Probeer het nog een keer";	
